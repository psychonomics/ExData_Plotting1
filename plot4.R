...
#-------------------------------------------------------------------------
#### Plot 4 - Block of 4 Charts [2x2]

# Create a call to the driver device
png(file = "plot4.png", width = 480, height = 480)

# Create a grid to plot the 4 charts
par(mfrow=c(2,2))

# Plot 1: Global Active Power by DateTime
plot(x = df2.cht$DateTime, y = df2.cht$Global_active_power, 
     type = "l", col = "black", main = "", 
     xlab = "", ylab = "Global Active Power")

# Plot 2: Voltage by DateTime
plot(x = df2.cht$DateTime, y = df2.cht$Voltage, 
     type = "l", col = "black", main = "", 
     xlab = "", ylab = "Voltage")


# Plot 3: Sub_metering_1 by DateTime, with axis titles
...
# Plot 4: Global Active Power by DateTime
plot(x = df2.cht$DateTime, y = df2.cht$Global_reactive_power, 
     type = "l", col = "black", main = "", 
